...
public class TabHandler implements TabCompleter {
    ...
    private static final String[] ACTIONS = new String[] { "block", "+block", "-block", "click", "kill", "+container", "-container", "container", "chat", "command", "+inventory", "-inventory", "inventory", "item", "+item", "-item", "sign", "session", "+session", "-session", "username", "mount", "dismount", "leash", "unleash" };
